...
This document outlines security procedures and policies for the UbuntuMinervaNeue skin.
...
The most straightforward way to report a security vulnerability is via [GitHub](https://github.com/ubuntu/ubuntu-mediawiki-minerva-skin/security/advisories/new).
...
This method enables you to communicate vulnerabilities directly and confidentially with the maintainers of this repo.
...
1. Go to the [Security Advisories Page](https://github.com/ubuntu/ubuntu-mediawiki-minerva-skin/security/advisories) of the repository.
